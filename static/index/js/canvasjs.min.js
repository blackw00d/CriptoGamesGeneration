...
(function () {
    ...
    var Va = {}, ra = null, Ba = function () {
            ...
            return function (Q, C, P) {
                var G = P ? P.days : s, O = P ? P.months : v, R = P ? P.shortDays : q, N = P ? P.shortMonths : y;
                P = "";
                var U = !1;
                ...
                P = U ? "getUTC" : "get";
                var Z = Q[P + "Date"](), V = Q[P + "Day"](), X = Q[P + "Month"](), T = Q[P + "FullYear"](),
                    H = Q[P + "Hours"](), W = Q[P + "Minutes"](), a = Q[P + "Seconds"](), f = Q[P + "Milliseconds"](),
            ...
            s = String(s);
            var z = 1, Q = q = "", C = -1, P = [], G = [], O = 0, R = 0, U = 0, N = !1, Z = 0,
                Q = s.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            s = null;
            for (var V = 0; Q && V < Q.length; V++) if (s = Q[V], "." === s && 0 > C) C = V; else {
            ...
            for (N = Q = V = R = C = 0; 0 < P.length;) if (s = P.pop(), "#" === s || "0" === s) if (C++, C === O) {
                ...
                (q = x + q)
            } else 0 < z.length ? (q = z.pop() + q, R++, N++) : "0" === s && (q = "0" + q, R++, N++), 0 === N % Q && (V === U && 0 < z.length) && (q = x + q); else "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length - 1] || !/[eE][+-]*[0]+/.test(s) ? "," === s ? (V++, Q = N, N = 0, 0 < z.length && (q = x + q)) : q = 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? s.slice(1, s.length - 1) + q : s + q : (s = 0 > Z ? s.replace("+", "").replace("-", "") : s.replace("-", ""), q += s.replace(/[0]+/, function (m) {
            ...
            return {x: s, y: q}
        }, Xa = !0, Qa = window.devicePixelRatio || 1, La = 1, ha = Xa ? Qa / La : 1, ka = function (m) {
            for (var s = "", q = 0; q < m.length; q++) s += String.fromCharCode(Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(q));
            return s
        },
    ...
    X.prototype.createUserOptions = function (m) {
        if ("undefined" !== typeof m || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
            this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] =
                []);
            var s = this.parent.options[this.optionsName], q = s.length;
    ...
    X.prototype.updateOption = function (m) {
        var s = sa[this._defaultsKey], q = {}, v = this[m], x = this._themeOptionsKey, z = this._index;
    ...
    la.prototype._getLineWithWidth = function (m, s, v) {
        ...
        for (this.ctx.font = this._getFontString(); y <= x;) {
            ...
            if (v < s) y = z + 1; else if (v > s) x = z - 1; else break
        }
    ...
    la.prototype._wrapText = function () {
        ...
        if (0 === this.frontSize) x = y = 0; else for (; 0 < m.length;) {
            ...
            v.push(G);
            var Q = x, x = Math.max(x, G.width), y = y + G.height, m = Ga(m.slice(G.text.length, m.length));
    ...
    Ia.prototype.render = function () {
        if (this.text) {
            var m = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, v = m.layoutManager.getFreeSpace(),
                q = v.x1, x = v.y1, z = 0, G = 0,
                R = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, Q, C;
    ...
    x.Chart = function () {
        ...
        function q(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                var c = 0, e = 0, c = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new fa(this), this.windowResizeHandler = N(window, "resize", function () {
                    ...
                    b._touchEventHandler(a)
                }), this.toolTip = new Y(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY =
        ...
        q.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled) {
                ...
                this._resetButton || (f = !1, wa(this._resetButton =
                    ...
                    if (a.sessionVariables.axisY) for (c = 0; c < a.sessionVariables.axisY.length; c++) a.sessionVariables.axisY[c].newViewportMinimum =
        ...
        q.prototype.render = function (a) {
            a && (this.options = a);
            this._initialize();/*bb(this);cb(this);*/
            var f = [];
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (c || b) for (var f = a.axisY.dataInfo, g = a.axisX.dataInfo, k, h = g.min, n = g.max, l = f.min, t = f.max, g = g._dataRanges, f = f._dataRanges, p, r = 0, m = 0; m < a.dataSeriesIndexes.length; m++) {
                        ...
                        (g[p].min = k), k > g[p].max && (g[p].max = k)), b) {
                            ...
                            if ((k = "waterfall" === a.type ? v.dataPointEOs[r].cumulativeSum : v.dataPoints[r].y) && k.length) for (var q = 0; q < k.length; q++) p = Math.floor((k[q] - l) / s), k[q] < f[p].min && (f[p].min = k[q]), k[q] > f[p].max && (f[p].max = k[q]); else y(k) || (p = Math.floor((k - l) / s), k < f[p].min && (f[p].min = k), k > f[p].max && (f[p].max = k))
                        }
                    }
                }
            }
        ...
        q.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var h = na("indexLabelFontWeight", k.dataPoint, k.dataSeries),
                    ...
                    u = {percent: null, total: null}, S = null;
                ...
                if (null !== ca && "" !== ca) {
                    var u = na("indexLabelPlacement", k.dataPoint, k.dataSeries),
                        S = na("indexLabelOrientation", k.dataPoint, k.dataSeries), s = k.direction,
                        q = k.dataSeries.axisX, A = k.dataSeries.axisY, x = !1, d = new la(f, {
                            x: 0,
                            y: 0,
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        b.beginPath();
                        if (0 < r.length) {
                            for (var s = !1, u = 0; u < r.length; u++) if (S = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(S < a.axisX.dataInfo.viewPortMin || S > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !s))) if ("number" !== typeof r[u].y) 0 <
        ...
        q.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    b.beginPath();
                    if (0 < r.length) {
                        for (var s = !1, u = 0; u < r.length; u++) if (S = r[u].getTime ? r[u].x.getTime() : r[u].x, !(S < a.axisX.dataInfo.viewPortMin || S > a.axisX.dataInfo.viewPortMax &&
                            (!k.connectNullData || !s))) if ("number" !== typeof r[u].y) 0 < u && !(k.connectNullData || s || D) && (b.stroke(), v && c.stroke()), s = !0; else {
                            var q = ca;
                            S = a.axisX.convertValueToPixel(S);
                            ca = a.axisY.convertValueToPixel(r[u].y);
                            ...
                            (r[u].indexLabel || k.indexLabel || r[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stepLine", dataPoint: r[u], dataSeries: k, point: {
                                    x: S,
                                    y: ca
                                }, direction: 0 > r[u].y === a.axisY.reversed ? 1 : -1, color: w
                            })
                        }
                        b.stroke();
                        v && c.stroke()
        ...
        q.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var D = 0, u, S, q = [];
                    c.beginPath();
                    if (0 < r.length) for (S = !1, D = 0; D < r.length; D++) if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !S))) if ("number" !== typeof r[D].y) 0 < D && !S && (k.connectNullData ? c.setLineDash && (0 < q.length && (k.options.nullDataLineDashType ||
        ...
        q.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var n = a.dataSeriesIndexes[r], d = this.data[n],
                        w = d.dataPoints;
        ...
        q.prototype.renderArea = function (a) {
            ...
            function c() {
                A && (0 < w.lineThickness && g.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = y : 0 > a.axisY.viewportMaximum ? B = t.y1 : 0 < a.axisY.viewportMinimum && (B = l.y2), g.lineTo(u, B), g.lineTo(A.x, B), g.closePath(), g.globalAlpha = w.fillOpacity, g.fill(), g.globalAlpha = 1, v && (h.lineTo(u, B), h.lineTo(A.x, B), h.closePath(), h.fill()), g.beginPath(),
                    g.moveTo(u, s), h.beginPath(), h.moveTo(u, s), A = {x: u, y: s})
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var d = a.dataSeriesIndexes[n], w = this.data[d],
                        m = w.dataPoints, k = w.id;
                    ...
                    if (0 < m.length) {
                        var x = w._colorSet[D % w._colorSet.length], z = w.lineColor = w.options.lineColor || x, J = z;
                        g.fillStyle = x;
                        g.strokeStyle = z;
                        ...
                        for (var ea = !0; D < m.length; D++) if (q = m[D].x.getTime ? m[D].x.getTime() : m[D].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !ea))) if ("number" !== typeof m[D].y) w.connectNullData || (ea || f) || c(), ea = !0; else {
                            ...
                            (m[D].indexLabel || w.indexLabel || m[D].indexLabelFormatter || w.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "area", dataPoint: m[D], dataSeries: w, point: {x: u, y: s}, direction: 0 >
        ...
        q.prototype.renderSplineArea = function (a) {
            function f() {
                ...
                if (0 < b.length) {
                    if (0 < p.lineThickness) {
                        ...
                        for (var d = 0; d < b.length - 3; d += 3) if (c.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), v &&
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e =
                        this._eventManager.ghostCtx, g = a.axisX.lineCoordinates, h = a.axisY.lineCoordinates, l = [],
                    t = this.plotArea;
                c.save();
                v && e.save();
                c.beginPath();
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    l = R(l);
                    e.fillStyle = l;
                    var l = [], d = 0, w, m, D = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        a.axisY.viewportMinimum : 0), u, s = null, q = [];
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (c.setLineDash) {
                            var L = G(p.nullDataLineDashType, p.lineThickness), z = p.lineDashType,
                                J = G(z, p.lineThickness);
                            c.setLineDash(J)
                        }
                        for (m = !1; d < n.length; d++) if (w = n[d].x.getTime ? n[d].x.getTime() : n[d].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m))) if ("number" !==
                            typeof n[d].y) 0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = L, z = p.nullDataLineDashType) : (f(), q = [])), m = !0; else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < m.length) {
                        ...
                        var I = "solid";
                        if (g.setLineDash) {
                            var da = G(w.nullDataLineDashType, w.lineThickness), I = w.lineDashType,
        ...
        q.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = [], h = this.plotArea, l = [], t = [], k = [], r = [], p = 0, n, d, w,
                    ...
                    s = this._eventManager.ghostCtx, u, q, y;
                v && s.beginPath();
                c.save();
                v && s.save();
                c.beginPath();
                ...
                for (x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    if (0 < k.length) {
                        var e =
                            A._colorSet[0], L = A.lineColor = A.options.lineColor || e, J = L;
                        c.fillStyle = e;
                        c.strokeStyle = L;
                        ...
                        for (var ea = !0, p = 0; p < k.length; p++) {
                            w = k[p];
                            var $ = null, $ = 0 <= A.dataPointIndexes[w] ? z[A.dataPointIndexes[w]] : {x: w, y: null};
                            if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ea))) if ("number" !== typeof $.y) A.connectNullData ||
                            (ea || q) || f(), ea = !0; else {
                                ...
                                0 <= A.dataPointIndexes[w] && 0 !== $.markerSize && (0 < $.markerSize || 0 < A.markerSize) && (w = A.getMarkerProperties(A.dataPointIndexes[w], n, d, c), g.push(w), markerColor = R(oa), v && g.push({
                                    x: n, y: d, ctx: s, type: w.type, size: w.size,
                                    color: markerColor, borderColor: markerColor, borderThickness: w.borderThickness
                                }));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    this._eventManager.objectMap[e] =
                        {objectType: "dataSeries", dataSeriesIndex: B};
                    e = R(e);
                    y.fillStyle = e;
                    t = [];
                    if (0 < k.length) {
                        var e = A._colorSet[p % A._colorSet.length], L = A.lineColor = A.options.lineColor || e, J = L;
                        c.fillStyle = e;
                        c.strokeStyle = L;
                        c.lineWidth = A.lineThickness;
                        u = "solid";
                        ...
                        for (var ea = !0, p = 0; p < k.length; p++) {
                            ...
                            if (!(w < a.axisX.dataInfo.viewPortMin ||
                                w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ea))) if ("number" !== typeof $.y) A.connectNullData || (ea || s) || f(), ea = !0; else {
                                var xa;
        ...
        q.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                a.dataSeriesIndexes.length; k++) for (var r = a.dataSeriesIndexes[k], p = this.data[r], n = p.dataPoints, d = 0, e = 0; e < n.length; e++) g = n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[e].z || (d = n[e].z, d > l && (l = d), d < t && (t = d));
                for (var w = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(c.height, c.width) / 2, 2) * Math.PI, w), k = 0; k < a.dataSeriesIndexes.length; k++) if (r = a.dataSeriesIndexes[k], p = this.data[r], n = p.dataPoints, 0 < n.length) for (b.strokeStyle = "#4572A7 ",
                                                                                                                                                                                                                                                                  e = 0; e < n.length; e++) if (g = n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, h = this.plotArea, l = 0, t, k, r, p, n, d,
                    ...
                    g = this.dataPointMaxWidth ? this.dataPointMaxWidth :
                        this.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < q.length) for (var ca = 5 < w && u.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++) if (q[l].getTime ? d = q[l].x.getTime() : d = q[l].x, !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(q[l].y) && q[l].y.length && "number" === typeof q[l].y[0] &&
                    "number" === typeof q[l].y[1] && "number" === typeof q[l].y[2] && "number" === typeof q[l].y[3]) {
                        ...
                        var x = t - w / 2 << 0, B = x + w << 0,
                            ...
                            z = 0 === A % 2 ? 0 : 0.5, L = u.dataPointIds[l];
        ...
        q.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var u = a.dataSeriesIndexes[s], q = this.data[u], x = q.dataPoints;
                    if (0 < x.length) for (var z = 5 < w && q.bevelEnabled ? !0 : !1, h = 0; h < x.length; h++) if (x[h].getTime ?
                        ...
                        var B = l - w / 2 << 0, A = l + w / 2 << 0, e = x[h].color ? x[h].color : q._colorSet[0],
                            C = Math.round(Math.max(1, 0.15 * w)), L = 0 === C % 2 ? 0 : 0.5,
                            ...
                            K = 1 === Math.round(O) % 2 ? 0.5 : 0, N = q.upperBoxColor, U = q.lowerBoxColor,
                            ta = y(q.options.fillOpacity) ? 1 : q.fillOpacity, M = q.dataPointIds[h];
        ...
        q.prototype.renderRangeColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < d.length) for (var w = 5 < k && n.bevelEnabled ? !0 : !1, g = 0; g < d.length; g++) if (d[g].getTime ? t = d[g].x.getTime() : t = d[g].x, !(t <
        ...
        q.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var x = a.dataSeriesIndexes[s], ba = this.data[x], B = ba.dataPoints,
                        A = y(ba._linkedSeries) ? !1 : ba._linkedSeries.type.match(/(bar|column)/ig) && ba._linkedSeries.visible ? !0 : !1,
                        C = 0;
                    if (A) for (e = ba._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) &&
        ...
        q.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, l, t, k,
                    g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth :
                        1;
            ...
            function (a) {
                ...
                if (!(0 >=
                    ...
                    for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (0 < p.length) {
                            var y = r._colorSet[d %
                            r._colorSet.length], x = r.lineColor = r.options.lineColor || y, B = x;
                            c.fillStyle = y;
                            c.strokeStyle = x;
        ...
        q.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e =
                    this._eventManager.ghostCtx, g = [], h = this.plotArea;
                c.save();
                v && e.save();
                c.beginPath();
                c.rect(h.x1, h.y1, h.width, h.height);
        ...
        q.prototype.renderPie = function (a) {
            function f() {
                if (k && r) {
                    for (var a = 0, b = 0, c = 0, e = 0, f = 0; f < r.length; f++) {
                        ...
                        var l = d[f], p =
                            {percent: null, total: null}, m = null, p = t.getPercentAndTotal(k, g);
            ...
            function g(a, b, f) {
                ...
                if (0 <= a && a < r.length) {
                    ...
                    h = null;
                    for (n = 1; n < r.length; n++) if (h = (a - n + d.length) % d.length, d[h].hemisphere !==
                    d[a].hemisphere) {
                        h = null;
                        break
            ...
            function h() {
                ...
                for (var b = a = 0, f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                    ...
                    for (a = 0; a < r.length; a++) if (l = d[a], B = l.indexLabelTextBlock.measureText(),
        ...
        q.prototype.renderFunnel = function (a) {
            ...
            function g() {
                var a, b, c, e;
                if ("inside" !== u.indexLabelPlacement) for (var f = 0; f < M.length; f++) 0 == F[f].textBlock.text.length ? F[f].isDirty = !0 : (a = M[f], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) /
            ...
            function h() {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += F[b.id].height + ha, F[b.id].textBlock.text =
                        "", F[b.id].indexLabelText = "", F[b.id].isDirty = !0, F[b.id].textBlock.measureText(); else break;
                    return g
                }
            ...
            function t(a, b, c) {
                var d, e, f, h = [], l = C, n = [];
                -1 !== b && (0 <= ma.indexOf(b) ? (e = ma.indexOf(b), ma.splice(e, 1)) : (ma.push(b), ma = ma.sort(function (a, b) {
                    return a - b
                })));
            ...
            if (!(0 >=
                ...
                var I = z.x1 + B, P = z.x2 - B, Q = z.y1 + C, $ = z.y2 - C,
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    var B = I + a / 2, X = I, V = I + a, T = u.reversed ? $ : Q, K = B - E / 2, Y = B + E / 2,
                        aa = u.reversed ? Q + N : $ - N, ta = u.reversed ? Q : $;
                    a = [];
                    var B = [], M = [], L = [], W = Q, ga, fa = (aa - T) / (K - X), ia = -fa,
                    ...
                    if (-1 !== I) {
                        ...
                        if (u.reversed) for (E = 0; E < I.length; E++) L[E] < aa ? (a.push(K), B.push(Y), ga = E) : (a.push((L[E] - T + fa * X) / fa), B.push((L[E] - T + ia * V) / ia)); else for (E = 0; E < I.length; E++) L[E] < aa ? (a.push((L[E] - T + fa * X) / fa), B.push((L[E] - T + ia * V) / ia), ga = E) : (a.push(K), B.push(Y));
        ...
        q.prototype.getPercentAndTotal = function (a, f) {
            ...
            if (0 <= a.type.indexOf("stacked")) c = 0, b = f.x.getTime ? f.x.getTime() : f.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], e = isNaN(f.y) ? 0 : 100 * (f.y / c)); else if ("pie" ===
        ...
        q.prototype.replaceKeywordsWithValue = function (a, f, b, c, e) {
            ...
            if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type || "funnel" === b.type || "pyramid" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var h = "#percent", l = "#total", t = this.getPercentAndTotal(b,
                    f), l = isNaN(t.total) ? l : t.total, h = isNaN(t.percent) ? h : t.percent;
                do {
                    t = "";
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,
                function (a) {
                    ...
                    if (f.hasOwnProperty(a)) d =
                        f; else if (b.hasOwnProperty(a)) d = b; else return "";
                    d = d[a];
                    null !== h && (d = d[h]);
        ...
        T.prototype.render = function () {
            var a = this.dockInsidePlotArea ?
                this.chart.plotArea : this.chart, f = a.layoutManager.getFreeSpace(), b = null, c = 0, e = 0, g = 0,
                h = 0,
                ...
                if (n.dataPoints && n.dataPoints.length) if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                    ...
                    var z = n.dataPoints[x],
                        ...
                        v = z.legendMarkerBorderThickness ? z.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : z.markerBorderThickness || n.markerBorderThickness ?
                            Math.max(1, Math.round(0.2 * s)) : 0, m = this.chart.replaceKeywordsWithValue(m, z, n, x),
                        d = {
                            markerType: d,
                            markerColor: q,
                            text: m,
                    ...
                    if (!(0 >= h || "undefined" === typeof h || 0 >= q || "undefined" === typeof q)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(d.textBlock.width + s + l + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === d.chartType || "spline" === d.chartType || "stepLine" === d.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) n =
                                {items: [], width: 0}, k.push(n), this.height += x, x = 0;
        ...
        Q.prototype.getDataPointAtXY = function (a, f, b) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                ...
                p = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < n ? Math.min(Math.max((this.dataPoints.length -
                ...
                if (0 <= g && g < this.dataPoints.length) {
                    ...
                    if (n) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var q = na("markerSize", d, this) || 4, s = b ? 20 : q,
        ...
        C.prototype.createLabels = function () {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), c = 0, d = n; c < this.logLabelValues.length; c++) if (b = this.logLabelValues[c], b < this.viewportMinimum) c++; else {
        ...
        C.prototype.createLabelsAndCalculateWidth = function () {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                for (f = 0; f < this._labels.length; f++) {
                    var b = this._labels[f].textBlock, c = b.measureText(), e = 0,
        ...
        C.setLayoutAndRender = function (a, f, b, c, e, g) {
            ...
            if ("normal" === e) {
                ...
                s;) {
                    var E = 0, T = 0, U = 0, X = 0, V = e = 0, K = 0, Z = 0, Y = 0, W = 0, M = 0, aa = 0;
                    if (b && 0 < b.length) for (G = [], d = M = 0; d < b.length; d++) G.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateWidth() : 0)), M += G[d], K += b[d] ? b[d].margin : 0; else G.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(G);
                    if (c && 0 < c.length) for (B = [], d = aa = 0; d < c.length; d++) B.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateWidth() : 0)), aa += B[d], Z += c[d] ? c[d].margin : 0; else B.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(B);
                    h = Math.round(g.x1 +
                        M + K);
                    ...
                    P.push(C);
                    if (a && 0 < a.length) for (d = 0; d < a.length; d++) a[d] &&
                    ...
                    if (c && 0 < c.length) for (d = 0; d < c.length; d++) c[d] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : f[0].lineCoordinates.x2), t = Math.round(h), K = c[d]._labels && 0 < c[d]._labels.length ? c[d]._labels[c[d]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + W + V < Math.max(K, 10) ? Math.max(K,
                    ...
                    if (a && 0 < a.length) for (d = 0; d < a.length; d++) a[d] && (a[d].calculateValueToPixelConversionParameters(),
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = O[s - 1][d] === O[s][d] ? !0 : !1; else q = !0;
                        if (f && 0 < f.length) for (d = 0; d < f.length; d++) J = P[s - 1][d] === P[s][d] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (d = 0; d < b.length; d++) I = R[s - 1][d] === R[s][d] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (d = 0; d < c.length; d++) N = Q[s - 1][d] === Q[s][d] ? !0 : !1; else N = !0
                    }
                    if (q && J && I && N) break;
                    s++
                }
                ...
                for (R = []; 4 > s;) {
                    ...
                    if (a && 0 < a.length) for (x = [], d = Y = 0; d < a.length; d++) x.push(Math.ceil(a[d] ? a[d].createLabelsAndCalculateWidth() : 0)), Y += x[d], e += a[d] ? a[d].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    P.push(x);
                    if (f && 0 < f.length) for (H = [], d = W = 0; d < f.length; d++) H.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)), W += H[d], V += f[d] ? f[d].margin :
                        0; else H.push(Math.ceil(f[0] ? f[0].createLabelsAndCalculateWidth() : 0));
                    R.push(H);
                    ...
                    if (b && 0 < b.length) for (A = [], d = X = 0; d < b.length; d++) A.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateHeight() : 0)), X += A[d] + b[d].margin, K += b[d].margin; else A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(A);
                    if (c && 0 < c.length) for (L = [], d = M = 0; d < c.length; d++) L.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateHeight() :
                        0)), M += L[d], Z += c[d].margin; else L.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    O.push(L);
                    ...
                    if (m.panEnabled) for (d = 0; d < b.length; d++) A[d] = m.sessionVariables.axisY.height; else for (d = 0; d < b.length; d++) m.sessionVariables.axisY.height = A[d];
                    ...
                    if (a && 0 < a.length) for (d = 0; d < a.length; d++) {
                        ...
                        if (b &&
                            0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (t = 0 > b[K].labelAngle ? Math.max(t, z) : 0 === b[K].labelAngle ? Math.max(t, z / 2) : t, h = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? t - Y : h);
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = P[s - 1][d] === P[s][d] ? !0 :
                            !1; else q = !0;
                        if (f && 0 < f.length) for (d = 0; d < f.length; d++) J = R[s - 1][d] === R[s][d] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (d = 0; d < b.length; d++) I = u[s - 1][d] === u[s][d] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (d = 0; d < c.length; d++) N = O[s - 1][d] === O[s][d] ? !0 : !1; else N = !0
                    }
                    if (q && J && I && N) break;
                    s++
                }
        ...
        C.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("bottom" === this._position) {
                ...
                "inside" === this.labelPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    for (k =
                             0; k < a._labels.length; k++) if (p = a._labels[k], !(p.position < a.viewportMinimum || p.position > a.viewportMaximum || f && 0 !== g++ % 2 && a.labelAutoFit) && (n = a.getPixelCoordinatesOnAxis(p.position), a.tickThickness)) {
                        a.ctx.lineWidth = a.tickThickness;
                        a.ctx.strokeStyle = a.tickColor;
                        var b = 1 === a.ctx.lineWidth % 2 ? (n.y << 0) + 0.5 : n.y << 0;
                        a.ctx.save();
            ...
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationIterationEnd", function () {
                for (k = 0; k < a._labels.length; k++) p = a._labels[k], p.position < a.viewportMinimum || (p.position > a.viewportMaximum || f && 0 !== g++ % 2 && a.labelAutoFit && p.skipFlag) || (a.ctx.save(), a.ctx.beginPath(), p.textBlock.render(!0),
                    a.ctx.restore())
            }, p.textBlock); else for (k = 0; k < this._labels.length; k++) p = this._labels[k], p.position < this.viewportMinimum || (p.position > this.viewportMaximum || f && 0 !== g++ % 2 && this.labelAutoFit && p.skipFlag) || p.textBlock.render(!0)
        };
        C.prototype.renderInterlacedColors = function () {
            var a = this.chart.plotArea.ctx, f, b, c = this.chart.plotArea, e = 0;
            f = !0;
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor) for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) f ? (f = this.getPixelCoordinatesOnAxis(this._labels[e].position),
        ...
        C.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                if (!h) {
                    ...
                    for (c = 0; c < m.length; c++) b = m[c], b.stripLine.showOnTop ? h || (h =
        ...
        C.prototype.renderGrid =
            function () {
                if (this.gridThickness && 0 < this.gridThickness) {
                    ...
                    if ("bottom" === this._position || "top" === this._position) for (c = 0; c < this._labels.length; c++) this._labels[c].position < this.viewportMinimum || (this._labels[c].position > this.viewportMaximum || this._labels[c].breaksLabelType) || (a.beginPath(), f = this.getPixelCoordinatesOnAxis(this._labels[c].position),
        ...
        C.prototype.convertPixelToValue = function (a) {
            ...
            if (this.logarithmic) {
                ...
                if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (b = 0; b < e.length; b++) {
                    if (!(e[b].endValue < this.conversionParameters.minimum)) if (f) if (e[b].startValue <
                ...
                if (b <= this.conversionParameters.reference ===
                    ...
                    e[b].size * (this.conversionParameters.minimum - e[b].startValue) / (e[b].endValue - e[b].startValue), c += e[b].size * (this.conversionParameters.minimum - e[b].startValue) / (e[b].endValue - e[b].startValue), f = !1; else if (c < e[b].endValue - this.conversionParameters.minimum) {
                    c -= e[b].endValue - this.conversionParameters.minimum;
                    if (c > -1 * e[b].size) {
                        a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c;
                        break
                    ...
                    c += e[b].size;
                    f = !1
                } else break; else if (c < e[b].endValue - e[b +
                1].startValue) {
                    c -= e[b].endValue - e[b + 1].startValue;
                    if (c > -1 * e[b].size) {
                        a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c;
        ...
        C.prototype.getApparentDifference = function (a, f, b, c) {
            ...
            } else for (b = y(b) ? Math.abs(f - a) : b, g = 0; g < e.length && !(f < e[g].startValue); g++) a > e[g].endValue || (a <= e[g].startValue && f >= e[g].endValue ?
        ...
        C.prototype.calculateValueToPixelConversionParameters = function (a) {
            ...
            if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * a[e].startValue, b = 0 < a[e].spacing.toString().indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100) : b - Math.min(a[e].spacing, 0.1 * b)) :
        ...
        C.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ?
                    62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40, c = 4;
                ...
                if (this.scaleBreaks) for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++) if ((!y(this.sessionVariables.newViewportMinimum) &&
        ...
        aa.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(c, l), this.ctx.lineTo(h, l), this.ctx.lineTo(h, e); else if ("wavy" === this.type) {
                    m = c;
                    k = e;
                    g = 0.5;
                    r = (l - k) / a / 3;
        ...
        ia.prototype.render = function (a, f) {
            ...
            if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString =
                this.parent.valueFormatString; else {
                var k = 0,
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    q = 0;
                    if ("rangeBar" === h[0].dataSeries.type || "error" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])), s = 0, n = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n); else s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n); else if ("stackedBar" ===
